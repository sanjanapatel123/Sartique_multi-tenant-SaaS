      ...
      <div className="container">
        ...
        >
          ...
          <div ref={leftCardRef}>
            <InfoCard
              side="left"
              label="Why Sartique Feels Different"
              title="Built Around How Your Brand"
              italicTitle="Actually Works."
              description="Sartique adapts to the way your team already operates, bringing structure and clarity without forcing you into rigid processes."
              list={[
                "No complicated onboarding",
                "No disruptive training",
                "No rebuilding your workflow",
              ]}
              bottomText="It simply feels natural from day one."
            />
          </div>
